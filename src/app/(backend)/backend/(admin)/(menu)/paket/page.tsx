...
// Disesuaikan: Tambahkan detail dan kategori ke Type
type Paket = {
    id: number;
    name: string;
    kategori: string | null; // Asumsikan string dan bisa null
    detail: string | null;   // Asumsikan string dan bisa null
    harga: string;
    paket_fitur: { id: number; fitur: string }[];
};
            ...
            >
                <div className="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-white/[0.05] dark:bg-white/[0.03]">
                    <div className="max-w-full overflow-x-auto">
                        {/* Menambah min-width agar semua kolom muat saat lebar kecil */}
                                ...
                                <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
                                    {allPaket.map((paket) => (
                                        <TableRow key={paket.id}>
                                            ...
                                            {/* Data Baru: Detail */}
                                            <TableCell className="px-5 py-4 sm:px-6 text-start max-w-xs overflow-hidden text-ellipsis whitespace-nowrap">
                                                <span className="text-gray-600 dark:text-gray-300" title={paket.detail || ''}>
                                                    {paket.detail || '-'}
                                                </span>
                                            </TableCell>
